...
import br.ufsm.inf.gkarkow.mqtt.impl.MqttMessage;
import br.ufsm.inf.gkarkow.mqtt.impl.MqttPersistenceException;
import br.ufsm.inf.gkarkow.mqtt.impl.MqttTopic;
import br.ufsm.inf.gkarkow.mqtt.impl.paho.PahoMqttClientFactory;
import br.ufsm.inf.gkarkow.mqtt.interfaces.IMqttCallback;
import br.ufsm.inf.gkarkow.mqtt.interfaces.IMqttClient;
import br.ufsm.inf.gkarkow.mqtt.interfaces.IMqttClientFactory;
import br.ufsm.inf.gkarkow.mqtt.interfaces.IMqttConnectOptions;
import br.ufsm.inf.gkarkow.mqtt.interfaces.IMqttMessage;
import br.ufsm.inf.gkarkow.mqtt.interfaces.IMqttPersistence;
import br.ufsm.inf.gkarkow.mqtt.interfaces.IMqttTopic;
import br.ufsm.inf.gkarkow.mqtt.logging.ConfigureLog4J;
...
public class MqttService extends Service implements IMqttCallback
{
    ...
    public static final String APP_ID = "br.ufsm.inf.gkarkow.termostt";
    
    // constants used to notify the Activity UI of received messages    
    public static final String MQTT_MSG_RECEIVED_INTENT = "br.ufsm.inf.gkarkow.termostt.MSGRECVD";
    public static final String MQTT_MSG_RECEIVED_TOPIC  = "br.ufsm.inf.gkarkow.termostt.MSGRECVD_TOPIC";
    public static final String MQTT_MSG_RECEIVED_MSG    = "br.ufsm.inf.gkarkow.termostt.MSGRECVD_MSG";
    
    // constants used to notify the Service of messages to send   
    public static final String MQTT_PUBLISH_MSG_INTENT = "br.ufsm.inf.gkarkow.termostt.SENDMSG";
    public static final String MQTT_PUBLISH_MSG_TOPIC  = "br.ufsm.inf.gkarkow.termostt.SENDMSG_TOPIC";
    public static final String MQTT_PUBLISH_MSG    = "br.ufsm.inf.gkarkow.termostt.SENDMSG_MSG";
    
    // constants used to tell the Activity UI the connection status
    public static final String MQTT_STATUS_INTENT = "br.ufsm.inf.gkarkow.termostt.STATUS";
    public static final String MQTT_STATUS_CODE    = "br.ufsm.inf.gkarkow.termostt.STATUS_CODE";
    public static final String MQTT_STATUS_MSG    = "br.ufsm.inf.gkarkow.termostt.STATUS_MSG";

    // constant used internally to schedule the next ping event
    public static final String MQTT_PING_ACTION = "br.ufsm.inf.gkarkow.termostt.PING";
